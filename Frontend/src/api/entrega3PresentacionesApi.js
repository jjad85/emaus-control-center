...
export const subirVersionAjustadaAudiovisuales = async (token, temaId, archivo, comentario) => (await postAction('subirVersionAjustadaAudiovisuales', { token, temaId, archivo, comentario }, { timeout: 180000 })).datos;
