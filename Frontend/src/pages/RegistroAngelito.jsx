...
import { registrarAngelitoPublico } from '../api/publicApi';
...
export default function RegistroAngelito() {
  ...
  async function enviar(event) {
    ...
    try {
      setEnviando(true);
      setError('');
      await registrarAngelitoPublico(form);
      setEnviado(true);
            ...
            <Grid container spacing={4} alignItems="center">
              <Grid size={{ xs: 12, md: 7 }}>
                ...
                <Typography sx={{ mt: 1.5, maxWidth: 760, color: 'text.secondary', fontSize: { xs: '1rem', md: '1.08rem' }, lineHeight: 1.75 }}>
                  Si ya viviste un Retiro de Emaús, puedes poner tu tiempo y tu alegría al servicio de quienes están viviendo esta experiencia.
                </Typography>
              </Grid>
        ...
        <Container maxWidth="lg" sx={{ py: { xs: 3, md: 5 } }}>
          {enviado ? (
            <Paper sx={{ p: { xs: 3, md: 5 }, borderRadius: 5, textAlign: 'center', border: '1px solid rgba(23,107,88,.14)', boxShadow: '0 20px 55px rgba(17,48,41,.08)' }}>
              ...
              <Typography variant="h4" fontWeight={950} mt={2}>¡Gracias por querer servir!</Typography>
              <Typography color="text.secondary" mt={1.2} mx="auto" maxWidth={620} lineHeight={1.7}>
                Recibimos tu inscripción como Angelito. El equipo organizador revisará la información y se pondrá en contacto contigo con las indicaciones necesarias.
              </Typography>
                ...
                <Paper sx={{ p: { xs: 2.25, md: 3 }, borderRadius: 5, border: '1px solid rgba(20,75,62,.11)', boxShadow: '0 14px 38px rgba(17,48,41,.055)' }}>
                    ...
                    <Grid container spacing={1.5}>
                      <Grid size={{ xs: 12, md: 6 }}>
                        <OpcionGrande
                          ...
                          texto="Puedo continuar con mi inscripción como Angelito."
                      ...
                      <Grid size={{ xs: 12, md: 6 }}>
                        <OpcionGrande
                          ...
                          texto="Primero es necesario vivir el retiro antes de servir como Angelito."
                  ...
                  {form.realizoEmaus === 'No' && (
                    <Alert severity="info" sx={{ mt: 2, borderRadius: 3 }}>
                      Para participar como Angelito es necesario haber vivido previamente un Retiro de Emaús.
                    </Alert>
                  )}
                    ...
                    <Paper sx={{ p: { xs: 2.25, md: 3 }, borderRadius: 5, border: '1px solid rgba(20,75,62,.11)', boxShadow: '0 14px 38px rgba(17,48,41,.055)' }}>
                      <Stack direction="row" spacing={1.3} alignItems="center" mb={2.2}>
                        ...
                        <Box>
                          ...
                          <Typography variant="h5" fontWeight={950}>Tu servicio como Angelito</Typography>
                        </Box>
                      </Stack>

                      <Typography fontWeight={900} mb={1.2}>¿Qué día vas a acompañarnos? *</Typography>
                      <Grid container spacing={1.5} mb={2.5}>
                        {['Viernes', 'Sábado'].map(dia => (
                          <Grid key={dia} size={{ xs: 12, sm: 6 }}>
                            <OpcionGrande
                              selected={form.diaServicio === dia}
                              icono={<VolunteerActivismRounded />}
                              titulo={dia}
                              texto={`Quiero servir como Angelito el ${dia.toLowerCase()}.`}
                              onClick={() => cambiar('diaServicio', dia)}
                            />
                          </Grid>
                        ))}
                      </Grid>
                      ...
                      <TextField
                        ...
                        sx={{ mt: 2.5 }}
                        placeholder="Cuéntanos algo que debamos tener en cuenta para organizar tu servicio."
                      />
                    </Paper>
