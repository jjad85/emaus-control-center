...
function obtenerCatalogoPermisosDefinitivo_() {
  return [
    ...
    ['SISTEMA_DOCUMENTOS_IDENTIDAD_VER','Sistema','Documentos de identidad','Consultar, visualizar, solicitar y exportar'],
...
function obtenerMatrizInicialRolesPermisos_() {
  ...
  dar('SISTEMA_DOCUMENTOS_IDENTIDAD_VER',['LIDER_RETIRO']);
