...
function convertirTema(registro) {
  return {
    ...
    cancionTipo: registro.cancionTipo || (convertirBooleano(registro.usaCancionEstandar) ? 'ESTANDAR' : 'PERSONALIZADA'),
    cancionNombre: registro.cancionNombre || '',
    cancionAutor: registro.cancionAutor || '',
    cancionEnlace: registro.cancionEnlace || '',
    cancionObservaciones: registro.cancionObservaciones || '',
    cancionEstado: registro.cancionEstado || (normalizarSiNoPendienteTema_(registro.requiereMusica) === 'Sí' ? 'Pendiente de gestión' : ''),
    cancionObservacionesAudiovisuales: registro.cancionObservacionesAudiovisuales || '',
    cancionAprobadaPor: registro.cancionAprobadaPor || '',
    cancionFechaAprobacion: registro.cancionFechaAprobacion || '',
    cancionArchivoDefinitivoId: registro.cancionArchivoDefinitivoId || '',
    cancionArchivoDefinitivoNombre: registro.cancionArchivoDefinitivoNombre || '',
    cancionArchivoDefinitivoUrl: registro.cancionArchivoDefinitivoUrl || '',
    ...
    usaVideo: normalizarSiNoPendienteTema_(registro.usaVideo) === 'Sí',
    videoTipo: registro.videoTipo || (convertirBooleano(registro.usaVideoEstandar) ? 'ESTANDAR' : 'PERSONALIZADO'),
    videoNombre: registro.videoNombre || '',
    videoAutorFuente: registro.videoAutorFuente || '',
    videoEnlace: registro.videoEnlace || '',
    videoCompleto: registro.videoCompleto === '' || registro.videoCompleto === undefined ? true : convertirBooleano(registro.videoCompleto),
    videoMinutoInicio: registro.videoMinutoInicio || '',
    videoMinutoFin: registro.videoMinutoFin || '',
    videoMomentoReproduccion: registro.videoMomentoReproduccion || '',
    videoObservaciones: registro.videoObservaciones || '',
    videoEstado: registro.videoEstado || (normalizarSiNoPendienteTema_(registro.usaVideo) === 'Sí' ? 'Pendiente de gestión' : ''),
    videoObservacionesAudiovisuales: registro.videoObservacionesAudiovisuales || '',
    videoAprobadaPor: registro.videoAprobadaPor || '',
    videoFechaAprobacion: registro.videoFechaAprobacion || '',
    videoArchivoDefinitivoId: registro.videoArchivoDefinitivoId || '',
    videoArchivoDefinitivoNombre: registro.videoArchivoDefinitivoNombre || '',
    videoArchivoDefinitivoUrl: registro.videoArchivoDefinitivoUrl || '',
    ...
    palancaDescripcion: registro.palancaDescripcion || '',
    palancaMomentoEntrega: registro.palancaMomentoEntrega || '',
    palancaDetalleMomento: registro.palancaDetalleMomento || '',
    palancaFormaEntrega: registro.palancaFormaEntrega || '',
    palancaResponsableEntrega: registro.palancaResponsableEntrega || '',
    palancaDetalleResponsable: registro.palancaDetalleResponsable || '',
    palancaCantidad: registro.palancaCantidad || '',
    palancaDestinatarios: registro.palancaDestinatarios || '',
    palancaRequierePreparacion: convertirBooleano(registro.palancaRequierePreparacion),
    palancaObservaciones: registro.palancaObservaciones || '',
    palancaEstado: registro.palancaEstado || (convertirBooleano(registro.requierePalanca) ? 'Pendiente de información' : ''),
    ...
    palancaObservacionesLogistica: registro.palancaObservacionesLogistica || '',
    palancaUltimaActualizacionLogistica: registro.palancaUltimaActualizacionLogistica || '',
    palancaEntregadaEjecucionPor: registro.palancaEntregadaEjecucionPor || '',
    palancaFechaEntregaEjecucion: registro.palancaFechaEntregaEjecucion || '',
