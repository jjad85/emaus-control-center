...
function obtenerCatalogoAlertas_() {
  return [
    ...
    { codigo:'VIDEO_CAMBIOS_AUDIOVISUALES', categoria:'Mis temas', nombre:'Cambios de Audiovisuales en videos', descripcion:'Avisa al servidor cuando Audiovisuales actualiza el estado, deja observaciones o carga el archivo definitivo de un video.', codigoCampana:'MIS_TEMAS_VIDEO' },
    { codigo:'CANCIONES_NOVEDADES', categoria:'Audiovisuales', nombre:'Novedades en canciones', descripcion:'Se muestra cuando existen canciones pendientes de preparación, validación, ajustes o aprobación.', codigoCampana:'CANCIONES_PENDIENTES' },
    { codigo:'VIDEOS_NOVEDADES', categoria:'Audiovisuales', nombre:'Novedades en videos', descripcion:'Se muestra cuando existen videos pendientes de preparación, validación, ajustes o aprobación.', codigoCampana:'VIDEOS_PENDIENTES' },
    { codigo:'PALANCAS_NOVEDADES', categoria:'Logística', nombre:'Novedades en palancas', descripcion:'Se muestra cuando existen palancas pendientes de preparación, validación, ajustes, aprobación o entrega.', codigoCampana:'PALANCAS_PENDIENTES' },
...
function obtenerMatrizInicialAlertas_() {
  return {
    ...
    VIDEO_CAMBIOS_AUDIOVISUALES:['ADMIN','LIDER_RETIRO','SERVIDOR'],
    CANCIONES_NOVEDADES:['ADMIN','AUDIOVISUAL','LIDER_RETIRO','SERVIDOR'],
    VIDEOS_NOVEDADES:['ADMIN','AUDIOVISUAL','LIDER_RETIRO','SERVIDOR'],
    PALANCAS_NOVEDADES:['ADMIN','LOGISTICA','LIDER_RETIRO','SERVIDOR'],
